...
namespace AIMuseVendor\Illuminate\Filesystem;

use Closure;
use AIMuseVendor\Illuminate\Contracts\Filesystem\Cloud as CloudFilesystemContract;
...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @param  \AIMuseVendor\Psr\Http\Message\UriInterface  $uri
     * @param  string  $url
     * @return \AIMuseVendor\Psr\Http\Message\UriInterface
     */
