...
use AIMuseVendor\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `AIMuseVendor\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `AIMuseVendor\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
