...
use DateTimeZone;
use AIMuseVendor\Monolog\Handler\HandlerInterface;
use AIMuseVendor\Psr\Log\LoggerInterface;
use AIMuseVendor\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \AIMuseVendor\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
