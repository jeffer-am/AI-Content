...
namespace AIMuseVendor\Monolog\Handler;

use AIMuseVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use AIMuseVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use AIMuseVendor\Monolog\Logger;
use AIMuseVendor\Monolog\ResettableInterface;
use AIMuseVendor\Monolog\Formatter\FormatterInterface;
use AIMuseVendor\Psr\Log\LogLevel;
 ...
 *
 * @phpstan-import-type Record from \AIMuseVendor\Monolog\Logger
 * @phpstan-import-type Level from \AIMuseVendor\Monolog\Logger
 * @phpstan-import-type LevelName from \AIMuseVendor\Monolog\Logger
 */
