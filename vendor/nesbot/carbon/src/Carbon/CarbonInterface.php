...
use AIMuseVendor\Carbon\Exceptions\InvalidDateException;
use AIMuseVendor\Carbon\Exceptions\InvalidFormatException;
use AIMuseVendor\Carbon\Exceptions\UnknownGetterException;
use AIMuseVendor\Carbon\Exceptions\UnknownMethodException;
use AIMuseVendor\Carbon\Exceptions\UnknownSetterException;
use Closure;
use DateInterval;
use DateTime;
...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
     ...
     * (second-precision).
     *
     * @param \AIMuseVendor\Carbon\Carbon|\DateTimeInterface|null $date
     *
     * @return static
     */
     ...
     *
     * @param Carbon|\AIMuseVendor\Carbon\CarbonPeriod|\AIMuseVendor\Carbon\CarbonInterval|\DateInterval|\DatePeriod|DateTimeInterface|string|null $date
     *
     * @return static
     */
     ...
     * current one).
     *
     * @param \AIMuseVendor\Carbon\CarbonInterface|\DateTimeInterface|string|null $date
