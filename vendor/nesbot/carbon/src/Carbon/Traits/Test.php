...
use AIMuseVendor\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
     ...
     *
     * @return \AIMuseVendor\Carbon\CarbonImmutable|\AIMuseVendor\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \AIMuseVendor\Carbon\CarbonImmutable|\AIMuseVendor\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \AIMuseVendor\Carbon\CarbonImmutable|\AIMuseVendor\Carbon\Carbon $testInstance */
