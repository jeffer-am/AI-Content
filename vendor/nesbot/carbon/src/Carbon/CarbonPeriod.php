...
use AIMuseVendor\Carbon\Exceptions\EndLessPeriodException;
use AIMuseVendor\Carbon\Exceptions\InvalidCastException;
use AIMuseVendor\Carbon\Exceptions\InvalidIntervalException;
use AIMuseVendor\Carbon\Exceptions\InvalidPeriodDateException;
use AIMuseVendor\Carbon\Exceptions\InvalidPeriodParameterException;
use AIMuseVendor\Carbon\Exceptions\NotACarbonClassException;
use AIMuseVendor\Carbon\Exceptions\NotAPeriodException;
use AIMuseVendor\Carbon\Exceptions\UnknownGetterException;
use AIMuseVendor\Carbon\Exceptions\UnknownMethodException;
use AIMuseVendor\Carbon\Exceptions\UnreachableException;
use AIMuseVendor\Carbon\Traits\IntervalRounding;
use AIMuseVendor\Carbon\Traits\Mixin;
use AIMuseVendor\Carbon\Traits\Options;
use AIMuseVendor\Carbon\Traits\ToStringFormat;
use Closure;
use Countable;
use DateInterval;
use DatePeriod;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \AIMuseVendor\Carbon\Carbon|\AIMuseVendor\Carbon\CarbonPeriod|\AIMuseVendor\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \AIMuseVendor\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \AIMuseVendor\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \AIMuseVendor\Carbon\Carbon|\AIMuseVendor\Carbon\CarbonPeriod|\AIMuseVendor\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \AIMuseVendor\Carbon\CarbonInterface
     */
